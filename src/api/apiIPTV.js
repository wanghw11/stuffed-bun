...
class apiContract{
    ...
    // 宽带提速  正式单
    checkKDHasPre(serialNumber){
        let wsmethod = "/mobile/speedUpBroadbandController/checkKDHasPre.json";
        let data = {
            serialNumber: serialNumber,
            source: '9999'
        }
    ...
    checkKDBroadbandNum(data){
        let wsmethod = "/mobile/speedUpBroadbandController/checkKDBroadbandNum.json";
        return axios.post(this.url+wsmethod, qs.stringify(data))
    }
    qryCbssPromByProductId(data){
        let wsmethod = "/mobile/speedUpBroadbandController/qryCbssPromByProductId.json";
        return axios.post(this.url+wsmethod, qs.stringify(data))
    }

    kdSpeedDataAdd(data){
        let wsmethod = "/mobile/speedUpBroadbandController/kdSpeedDataAdd.json";
        return axios.post(this.url+wsmethod, qs.stringify(data))
    }
    init(staffId){
        // touch-qrcode/business/wizard/init?token=02g0R0d472H6wg54931978
