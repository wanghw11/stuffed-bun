...
class apiContract {
  ...
  //新获取流量专区
  qryCoInfoByType(data) {
    let wsmethod = "/mobile/JfSysAcceptActionInfo/qryCoInfoByType.json";
    return axios.post(this.url + wsmethod, qs.stringify(data))
  }
  ...
  qryCbssPromByProductIdLimit(staffId, jfproductid) {
    let wsmethod = "/mobile/JfSysAcceptActionInfo/vueqryCbssPromByProductIdLimit.json";
    let data = {
      staffId: staffId,
  ...
  orderCommit2(data) {
    let wsmethod = "/mobile/AcceptActionInfo/orderCommit.json";
    return axios.post(this.url + wsmethod, qs.stringify(data))
  }
